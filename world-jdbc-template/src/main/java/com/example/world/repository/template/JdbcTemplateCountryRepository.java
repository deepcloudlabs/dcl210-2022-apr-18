...
public class JdbcTemplateCountryRepository implements CountryRepository {
	...
	public Collection<Country> findAll() {
		List<Country> countries = jdbcTemplate.queryForList(SELECT_ALL_COUNTRIES, Country.class);
	...
	public Collection<Country> getByContinent(String continent) {
		return jdbcTemplate.queryForList(SELECT_COUNTRIES_BY_CONTINENT, Country.class, continent);
	}
